...
func main() {
	...
	var CURRENCY_SERVICE_ADDR = os.Getenv("CURRENCY_SERVICE_ADDR")               //"currency:9001"
	...
	var PAYMENT_SERVICE_ADDR = os.Getenv("PAYMENT_SERVICE_ADDR")                 //"payment:8011"
		if PAYMENT_SERVICE_ADDR=="" {
		PAYMENT_SERVICE_ADDR="localhost:8011"
	}	
	var EMAIL_SERVICE_ADDR = os.Getenv("EMAIL_SERVICE_ADDR")                     //"email:4009"
		if EMAIL_SERVICE_ADDR=="" {
		EMAIL_SERVICE_ADDR="localhost:4009"
	}
