...
const OTLPGRPCTraceExporter = require('@opentelemetry/exporter-trace-otlp-grpc');
...
const provider = new WebTracerProvider({
    resource: new Resource({
        ...
        [SemanticResourceAttributes.SERVICE_NAME]: process.env.SERVICE_NAME || 'docker-currency-service',
...
if (OTLP_FORMAT == "HTTP") {
    ...
    const exporter = new OTLPGRPCTraceExporter.OTLPTraceExporter(collectorOptions)
    provider.addSpanProcessor(new BatchSpanProcessor(exporter, {
        // The maximum queue size. After the size is reached spans are dropped.
        maxQueueSize: 1000,
        // The interval between two consecutive exports
